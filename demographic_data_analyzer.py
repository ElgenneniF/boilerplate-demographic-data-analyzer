...
def calculate_demographic_data(print_data=True):
    ...
    total_lines = len(df)
    bachelors_lines = len(df[df['education'] == 'Bachelors'])
    percentage_bachelors = round(bachelors_lines / total_lines * 100, 1)
    ...
    percentage_high_earners = (high_earners_by_country / total_by_country) * 100
    ...
    df_IN = df[(df['native-country'] == 'India') & (df['salary'] == '>50K')]
    top_IN_occupation = df_IN['occupation'].value_counts().idxmax()
